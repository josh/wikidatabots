...
def parse_uriref(uri: str) -> URIRef:
    if uri.startswith(WDS):
        ...
        return PROVURIRef(uri)
    elif uri.startswith(PR):
        return PRURIRef(uri)
...
class WikidataURIRef(URIRef):
    ...
    def __init__(self, value: str):
        ...
        assert "/" not in self.local_name(), self
...
class PROVURIRef(WikidataURIRef):
    prefix: str = "prov"
    namespace: Namespace = PROV
