    ...
    df2 = pl.DataFrame(
        {
            ...
            "type": pl.Series(["movie", "movie", None], dtype=pl.Categorical),
            "success": [True, True, True],
            "imdb_numeric_id": pl.Series([1745960, 119116, None], dtype=pl.UInt32),
            "tmdb_id": pl.Series([361743, 18, None], dtype=pl.UInt32),
            "tvdb_id": pl.Series([16721, 305, None], dtype=pl.UInt32),
        }
    ).lazy()
